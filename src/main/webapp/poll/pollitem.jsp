...
.form-check-label {
    ...
    margin-left: 0.5rem; /* 체크박스와 글자 사이의 간격 조절 */
    font-size: 20px;
    margin-top: -5px;
}
...
<body>
	<div class="container mt-2">
		<h4 style="font-size: 2rem;">설문 정보</h4>
		<%
		if (dto != null) {
		%>
		<div class="container p-5 my-5 border">
			<label class="m-10" style="font-size: 25px;">설문 내용 : <%=dto.getQuestion()%></label>
			<form action="pollProc.jsp" class="p-3"
				...
				%>
				<button class="btn btn-primary mt-5">투표</button>
				<%
				}
				%>
